...
OUTFILE ${path_gwas}/post_imputation/2022/analysis/metaanalysis/${ph}/chr${chr}_${j}_${ph}_meta_withGC_PCs_${signal}_firthse_withGC_ .txt

ANALYZE HETEROGENEITY

QUIT" > ${path_gwas}/post_imputation/2022/analysis/metaanalysis/log/chr${chr}_${j}_${ph}_metal_input_withGC_PCs_${signal}_firthse_withGC.txt
...
OUTFILE ${path_gwas}post_imputation/2022/analysis/conditional_analysis_post_fm/regenie/metaanalysis/${ph}/chr${chr}_${j}_${ph}_meta_withGC_PCs_${signal}_firthse_withGC_ .txt
...
# EXECUTE METAL
/path/to/software/username/metal/./metal ${path_gwas}/post_imputation/2022/analysis/metaanalysis/log/chr${chr}_${j}_${ph}_metal_input_withGC_PCs_${signal}_firthse_withGC.txt
