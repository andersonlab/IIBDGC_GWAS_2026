...
for (chr in chr) {
  ...
  for (i in 1:length(array)) {
    ...
    file_raw<-paste(path_gwas,"post_imputation/2022/analysis/conditional_analysis/eur/",array[i],"_chr",chr,"_tier1_EUR_array_data_fine_mapping_tier_2_unsupervised_conditional_old_index.raw",sep="")
...
write.table(mod,paste(path_gwas,"post_imputation/2022/analysis/metaanalysis/chr",chr,"_tier1_EUR_array_data_fine_mapping_tier_2_unsupervised_conditional_old_index_subphenotype_models_adjusted_by_array_mc16.tsv.gz",sep=""),
...
write.table(mod,paste(path_gwas,"post_imputation/2022/analysis/metaanalysis/chr",chr,"_tier1_EUR_array_data_fine_mapping_tier_2_unsupervised_conditional_old_index_subphenotype_models_adjusted_by_array_by_pcs_mc16.tsv.gz",sep=""),
            col.names=T,row.names=F,sep="\t",quote=F)
