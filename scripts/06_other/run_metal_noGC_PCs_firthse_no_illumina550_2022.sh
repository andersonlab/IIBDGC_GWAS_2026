...
# PROCESS ${path_gwas}post_imputation/2022/analysis/regenie/illumina550/${ph}/allchr_illumina550_${j}_step2_${ph}_eur_sex_PCs_firthse_${ph}.regenie
...
OUTFILE ${path_gwas}/post_imputation/2022/analysis/metaanalysis/${ph}/${chr}_${j}_${ph}_meta_noGC_PCs_firthse_no_illumina550_ .txt

ANALYZE HETEROGENEITY

QUIT" > ${path_gwas}/post_imputation/2022/analysis/metaanalysis/log/allchr_${j}_${ph}_metal_input_noGC_PCs_firthse_no_illumina550.txt
...
# EXECUTE METAL
/path/to/software/metal/./metal ${path_gwas}/post_imputation/2022/analysis/metaanalysis/log/allchr_${j}_${ph}_metal_input_noGC_PCs_firthse_no_illumina550.txt
