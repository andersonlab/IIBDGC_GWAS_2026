...
OUTFILE ${path_gwas}/post_imputation/2022/analysis/metaanalysis/${ph}/allchr_${j}_${ph}_meta_withGC_PCs_firthse_withGC_ .txt

ANALYZE HETEROGENEITY

QUIT" > ${path_gwas}/post_imputation/2022/analysis/metaanalysis/log/allchr_${j}_${ph}_metal_input_withGC_PCs_firthse_withGC.txt
...
# EXECUTE METAL
/path/to/software/metal/./metal ${path_gwas}/post_imputation/2022/analysis/metaanalysis/log/allchr_${j}_${ph}_metal_input_withGC_PCs_firthse_withGC.txt
